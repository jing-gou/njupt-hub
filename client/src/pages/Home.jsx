        ...
        <div className={`relative ${isSearching ? 'z-[70]' : 'z-10'}`} onClick={() => isSearching && setIsSearching(false)}>
          <div className="relative pb-2">
            ...
            <div className={`relative max-w-4xl mx-auto px-4 pt-12 pb-4 text-center ${showFilter ? 'z-[100]' : ''}`}>
              <h1 className={`text-4xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r transition-all duration-900 ${darkMode ? 'from-blue-400 to-pink-400' : 'from-blue-600 to-pink-600'} ${isSearching ? 'opacity-10 blur-md scale-90' : 'opacity-100'}`}>
                NJUPT Hub
              </h1>
