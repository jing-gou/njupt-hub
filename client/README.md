...
这是一个基于 **Vite + React + Tailwind CSS** 构建的资料共享平台，旨在降低资料共享门槛，通过 Web 实现资料的共享。
所有资料存于 public/uploads
<br/>
> [!NOTE] 
> 感谢 [@deximy](https://github.com/deximy) 提供的 nju.pt 域名!
<br/>
...
1. **克隆项目**:
```bash
git clone https://github.com/jing-gou/njupt-hub.git
cd njupt-hub
```
